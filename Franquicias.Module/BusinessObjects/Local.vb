...
<DefaultClassOptions()>
Public Class Local ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    Inherits XPBaseObject ' Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
...
#End Region
    ...
    Public Property Franquiciado() As Franquiciado
        Get
...
#Region "Colecciones"
    <Association("Local-Publcidad"), DevExpress.Xpo.Aggregated()>
    Public ReadOnly Property Publicidades() As XPCollection(Of Publicidad)
        Get
            Return GetCollection(Of Publicidad)("Publicidades")
        End Get
    End Property

...
Partial Public NotInheritable Class FranquiciasAspNetModule
    Inherits ModuleBase
	...
	'	e.Store = New ModelDifferenceDbStore(CType(sender, XafApplication), GetType(ModelDifference), True, "Web")
	' 	e.Handled = True
	'End Sub
